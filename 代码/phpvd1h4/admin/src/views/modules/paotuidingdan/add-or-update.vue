<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="地点类型" prop="didianleixing">
          <el-select :disabled="ro.didianleixing" v-model="ruleForm.didianleixing" placeholder="请选择地点类型">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="跑腿费用" prop="paotuifeiyong">
          <el-input v-model="ruleForm.paotuifeiyong" 
              placeholder="跑腿费用" clearable  :readonly="ro.paotuifeiyong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="跑腿费用" prop="paotuifeiyong">
              <el-input v-model="ruleForm.paotuifeiyong" 
                placeholder="跑腿费用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `paotuidingdan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.paotuidingdanCrossAddOrUpdateFlag = false;
						 this.parent.search();
