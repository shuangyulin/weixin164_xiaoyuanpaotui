<template>
  <el-aside class="index-aside" width="250px">
      ...
      this.$nextTick(()=>{
        document.querySelectorAll('.menulist .el-menu-item').forEach(el=>{
          el.addEventListener("mouseenter", e => {
            e.stopPropagation()
            el.style.backgroundColor = "rgba(43, 190, 104, 0.97)"
          })
          el.addEventListener("mouseleave", e => {
            e.stopPropagation()
            // el.style.backgroundColor = "rgba(73, 161, 234, 1)"
...
<style lang="scss" scoped>
  ...
  .index-aside {
	...
	.menulist-item {
		...
		background: rgba(73, 161, 234, 1) !important;
		...
		&>.el-menu-item {
			...
			border-width: 0;
			border-style: solid;
			border-color: rgba(18, 18, 19, 1) !important;
			background-color: rgba(73, 161, 234, 1) !important;
		...
		& /deep/ .el-menu.el-menu--inline {
			...
			background-color: rgba(73, 161, 234, 1);
			...
			.el-menu-item {
                ...
                &.is-active {
                    ...
                    background-color: rgba(162, 210, 252, 1) !important;
                    box-shadow: 0 0 6px rgba(30, 144, 255, 0);
                    text-align: left;
                }
